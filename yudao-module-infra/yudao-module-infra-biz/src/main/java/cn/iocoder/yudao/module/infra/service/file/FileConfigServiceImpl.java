...
public class FileConfigServiceImpl implements FileConfigService {
     ...
     */
    @Getter
    private final LoadingCache<Long, FileClient> clientCache = buildAsyncReloadingCache(Duration.ofSeconds(1000L),
    ...
    @Override
    public FileClientConfig getDefultConfig(){
        FileClientConfig fileClientConfig = fileConfigMapper.selectByMaster().getConfig();
