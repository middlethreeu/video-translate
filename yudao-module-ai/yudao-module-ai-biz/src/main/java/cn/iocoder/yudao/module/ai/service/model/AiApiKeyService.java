...
public interface AiApiKeyService {
    ...
    ChatModel getChatModel(AiPlatformEnum platform);
    /**
     * 获得 ImageModel 对象
     *
    ...
    OpenAiAudioTranscriptionModel getOpenAiAudioTranscriptionModel(AiPlatformEnum platform);

    OpenAiAudioApi getOpenAiAudioApi(AiPlatformEnum platform);
    /**
     * 获得 MidjourneyApi 对象
     *
