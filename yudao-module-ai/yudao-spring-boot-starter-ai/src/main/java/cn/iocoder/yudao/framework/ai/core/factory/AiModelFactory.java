...
public interface AiModelFactory {
    ...
    OpenAiAudioTranscriptionModel getOrCreateOpenAiAudioTranscriptionModel(AiPlatformEnum platform, String apiKey, String url);

    OpenAiAudioApi getOrCreateOpenAiAudioApi(String openAiToken, String url);
    /**
